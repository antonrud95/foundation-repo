                    ...
                    {navlinks.map((link, index) => {
                      return(
                        <Link href={link.href} key={index}>
                                <a className={index === 0 ? 'transition duration-500 ease-in-out text-18-25 text-text mr-64 font-bold' : 'transition duration-500 ease-in-out text-18-25 text-text mr-64 hover:text-sky'}>
                                  {link.link}
                                </a>
                            </Link>
                        )
